...
// day3 class from canvas 
public class Day {
	/**
	 * Constructs a day with a given year, month, and day of the Julian/Gregorian
	 * calendar. The Julian calendar is used for all days before October 15, 1582
	 * 
	 ...
	 * @return the number of days that this day is away from the other (>0 if this
	 *         day comes later)
	 */
	 ...
	 * @return The Julian day number that begins at noon of the given day Positive
	 *         year signifies CE, negative year BCE. Remember that the year after 1
	 *         BCE is 1 CE.
	 * 
	 ...
	 * @return an array whose 0 entry is the year, 1 the month, and 2 the day of the
	 *         month.
	 */
